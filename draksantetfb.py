    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://m.facebook.com/Z.hani10')
                time.sleep(2)
                menu()
